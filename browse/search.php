...
<body>
      ...
      <div class="container d-flex flex-wrap">
        ...
        <ul class="nav">
          <?php if ($loggedIn) : ?>
            ...
            <!-- <li class="nav-item"><a href="../info/profile.php" class="nav-link link-dark px-2"><i class="bi bi-person-bounding-box"></i></a></li>&nbsp;&nbsp; -->
  ...
  <div class="container">
    ...
    $sql = "SELECT * FROM Books WHERE title LIKE '%" . $search . "%' OR author LIKE '%" . $search . "%' OR category LIKE '%" . $search . "%' OR isbn LIKE '%" . $search . "%'";
    ...
    if ($rows > 0) {
      ...
      <img style='padding-bottom: 20px;' src=" . $image[$i] . " width='175' height='250'>
            <p><strong>$title[$i]</strong></p>
            <form method='post'>
      ...
      echo "<div style='text-align: center;'><br><img src='../images/result.png' width='400'";
    }
    ?>
  </div>
