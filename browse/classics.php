...
<body>
  ...
  <div class="container banner" style="position: relative; text-align: center; margin-bottom: 3rem;">
    <h2 style="font-size: 30px">Classics</h2>
    <p style="font-size: 18px">Historical favorites. All right here.</p>
  </div>
<div class="container-fluid" style="padding-left: 10rem">
    ...
    // Pull from DB
    $sql = "SELECT * FROM Books WHERE category = 'Classic'";
    ...
    for ($i = 1; $i <= count($title); $i++) {
      echo
      "<div style='display: table-cell; text-align: center; padding-bottom: 20px;'>
