...
<body>
      ...
      <div class="container d-flex flex-wrap" style="font-size: 20px">
        ...
        <ul class="nav">
          ...
          <?php if ($loggedIn) : ?>
            ...
            <li class="nav-item"><a href="../info/profile.php" class="nav-link link-dark px-2 toplink">Account&nbsp;&nbsp;&nbsp;<i class="bi bi-person-square"></i></a></li>&nbsp;&nbsp;&nbsp;
          <?php elseif (!$loggedIn) : ?>
  ...
  <div class="container banner" style="position: relative; text-align: center; margin-bottom: 3rem;">
    <h2 style="font-size: 30px">Collections</h2>
    <p style="font-size: 18px">Books made just for each other.</p>
  </div>
<div class="container-fluid" style="padding-left: 10rem">
    ...
    // Pull from DB
    $sql = "SELECT * FROM Books WHERE category = 'Collections'";
