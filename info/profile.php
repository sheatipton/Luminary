...
<body>
  ...
  <main>
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 bg-light sidebar" style="width: 280px;">
      <a href="./profile.php" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
        <span class="fs-4 hd"><strong>Account</strong></span>
      </a>
      <hr>
    ...
    <div class="container" style="margin-bottom: 5rem;">
      <div class="row">
        <span class="title"><a href="index.php" style="font-size: 60px; color: #89A3B2"><i class="bi bi-house-fill"></i></a>Luminary - My Account</span>
      </div>
      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Account Settings - Welcome, <?php echo $name; ?></h5>
              <form method="post">
                ...
                <br><button type="submit" name="editAccount" class="btn btn-light">Save All</button>
                <!-- <button type="submit" name="deleteAccount" class="btn btn-light" data-bs-toggle="modal" data-target="#exampleModal">Delete Account</button> -->
                <!-- Button trigger modal -->
                <button type="button" name="editAccount" class="btn btn-light" data-toggle="modal" data-target="#exampleModal">
                  Delete Account
                </button>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <button type="submit" name="proceed" class="btn btn-light">Confirm</button>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="card-body">
              ...
              <form method="post" style="text-align: center">
                ...
                <div style="display:flex">
                  ...
                  <button type="submit" name="editAddresses" class="btn btn-light">Save All</button>
                </div>
                <form>
            </div>
          </div>
