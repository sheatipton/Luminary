...
<body>
  ...
  <main>
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 bg-light sidebar" style="width: 280px; font-size: 24px;">
      ...
      <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li class="nav-item">
          <a href="../info/faq.php" class="nav-link" aria-current="page">
    ...
    <div class="container" style="margin-bottom: 5rem;">
      <div class="row">
        <p style="font-size: 55px; color: #89A3B2; padding-top: 30px; padding-left: 40px">Welcome, <?php echo $name; ?></p>
        <i class="bi bi-balloon-heart" style="font-size: 50px; color: #89A3B2; padding-top: 30px; padding-left: 15px"></i>
      </div>
  ...
  <footer class="my-5 pt-5 text-muted text-center text-small">
    <p class="mb-1">&copy; Luminary, Inc. 2022. All rights reserved.</p>
  </footer>
