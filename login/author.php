...
<head>
 ...
 <header class="py-3 mb-4 border-bottom">
    ...
    <div class="container banner" style="position: relative; text-align: center; margin-bottom: 3rem;">
      <br><br><br>
      <h2 style="font-size: 45px">Sign Up as an Author</h2>
    </div>
    ...
    <form method="post"  style="display: inline-block">
      <div class="form-floating">
        ...
        <div style="display:inline-flex">
          ...
          <select style="height: 60px; font-size: 26px" name="state" class="form-control" style="width: 85px; height: 37px;" required>
          ...
          <input style="height: 60px; font-size: 26px" type="text" name="zip" class="form-control" placeholder="Zip" required><br>
        </div><br><br>
        <input style="height: 60px; font-size: 26px" type="password" name="password" class="form-control" placeholder="Password" minLength=6 required><br>
        <input style="height: 60px; font-size: 26px" type="password" name="confirm_password" class="form-control" placeholder="Confirm Password" minlength="6" required><br>
      ...
      ?>
      <button class="btn btn-light" style="background-color: #74B49B; color: white; width: 275px; font-size: 26px" type="submit">Create Account</button>
