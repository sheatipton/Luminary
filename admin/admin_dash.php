...
$productTotal = mysqli_num_rows($result);
        ...
        <div class="d-flex flex-column flex-md-row justify-content-md-between align-items-md-center py-2 text-center text-md-start">
          <div class="flex-grow-1 mb-1 mb-md-0">
            ...
            <h2 class="h6 fw-medium fw-medium text-muted mb-0">
              Welcome <a class="fw-semibold" href="#">Administrator</a>, everything looks great.
            </h2>
          </div>
        </div>
      </div>
          ...
          <div class="col-sm-6 col-xxl-4">
            ...
            <div class="block block-rounded d-flex flex-column h-100 mb-0">
              <div class="block-content block-content-full flex-grow-1 d-flex justify-content-between align-items-center">
                ...
                <div class="item item-rounded-lg bg-body-light"><big><?php echo $userTotal ?></big>
                </div>
              </div>
              <div class="bg-body-light rounded-bottom">
                <a class="block-content block-content-full block-content-sm fs-sm fw-medium d-flex align-items-center justify-content-between" href="userManagement/users.php">
          ...
          <div class="col-sm-6 col-xxl-4">
            <div class="block block-rounded d-flex flex-column h-100 mb-0">
              <div class="block-content block-content-full flex-grow-1 d-flex justify-content-between align-items-center">
                ...
                <div class="item item-rounded-lg bg-body-light"><big><?php echo $productTotal ?></big>
                </div>
              </div>
              <div class="bg-body-light rounded-bottom">
